...
const generate = (fn, dependency = LazyIterable) => {
  return Object.create(dependency, {
    [Symbol.iterator]: {
      value: fn
    }
  })
...
module.exports.LazyIterable = LazyIterable
module.exports.LazyIterableDescriptor = LazyIterableDescriptor
module.exports.Lazy = {
  generate: generate,
  compose: compose,
  take: takeIterable,
